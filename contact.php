...
<html>
<head>
    <title>contact | Rental Library | KUET</title>
    ...
    <div class="content">
       ...
       <div style="width:850px;float:left;padding-left:10px;padding-top:10px;">
              <div style="float:left;">
                             <p style="float:left;text-align:left;"><b>Address :</b> Dept. of Computer Science & Engineering <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Khulna University of Engineering & Technology<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Khulna-9203, Bangladesh.<br/>
                                    <b>Fax :</b> +880-41-750105<br/>
                                    <b>PABX :</b> +880-41-750742-3, 751320-1<br/>
                                   <b>Website:</b><a href="http://cse.kuet.ac.bd/" target="_blank">cse.kuet.ac.bd</a><br/>
                                   <b>E-mail:</b> cse@kuet.ac.bd</p>
             </div>

       </div>
    
        <div class="right_side" style="float:right;">
            <h2>Important <br>links</h2><hr/>
            <ul>
